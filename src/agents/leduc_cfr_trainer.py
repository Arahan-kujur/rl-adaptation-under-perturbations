"""CFR solver for Leduc Poker -- full game-tree enumeration."""
...
class LeducCFRTrainer:
    """Vanilla CFR with full game-tree traversal for Leduc Poker.

    Enumerates all 120 (p0, p1, community) deals per iteration.
    """
